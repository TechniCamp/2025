...
import { Sparkles, BookOpen, FileText, Loader2, History, PlusCircle, ArrowRight, Search } from 'lucide-react';
          ...
          <div className="lg:col-span-8">
                ...
                {selectedNote ? (
                  <div className="space-y-4">
                    ...
                    <Button 
                      ...
                      disabled={loading}
                      className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-2 px-4 rounded-lg shadow-lg transition-all duration-300 hover:shadow-blue-900/40"
                    >
                      {loading ? (
                        <>
                  ...
                  <div className="text-center p-6">
                    ...
                    <p className="text-gray-400">Select a note from the list to generate a learning scenario</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            {generatedScenario && (
              <Card className="bg-slate-800/50 backdrop-blur border border-slate-700/50 shadow-xl overflow-hidden">
                <CardHeader className="border-b border-slate-700/50 bg-slate-800/70">
                  <CardTitle className="flex items-center">
                ...
                <CardContent className="p-5">
                  <div className="p-5 bg-slate-900/80 border border-slate-700/80 rounded-lg shadow-inner">
                    <div className="prose prose-invert max-w-none" dangerouslySetInnerHTML={{ __html: generatedScenario }} />
                  </div>
                </CardContent>
              </Card>
            )}
