...
const sampleNotes = [
  { id: "1", title: "Podstawy programowania", content: "Programowanie to proces tworzenia programów komputerowych..." },
  {
    id: "2",
    title: "Algorytmy sortowania",
    content: "Sortowanie to proces układania elementów w określonej kolejności...",
  },
  {
    id: "3",
    title: "Struktury danych",
    content: "Struktury danych to sposoby organizowania i przechowywania danych...",
  },
  {
    id: "4",
    title: "Bazy danych SQL",
    content: "SQL (Structured Query Language) to język używany do zarządzania bazami danych...",
  },
  { id: "5", title: "Sieci komputerowe", content: "Sieci komputerowe umożliwiają komunikację między urządzeniami..." },
  {
    id: "6",
    title: "Sztuczna inteligencja",
    content: "Sztuczna inteligencja to dziedzina informatyki zajmująca się tworzeniem systemów...",
  },
  {
    id: "7",
    title: "Programowanie obiektowe",
    content: "Programowanie obiektowe to paradygmat programowania oparty na koncepcji obiektów...",
  },
  {
    id: "8",
    title: "Języki programowania",
    content: "JavaScript, Python, Java, C++ to popularne języki programowania używane do...",
  },
  {
    id: "9",
    title: "Bezpieczeństwo IT",
    content: "Bezpieczeństwo IT obejmuje praktyki i technologie chroniące systemy komputerowe...",
  },
  {
    id: "10",
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
                  {notes.map((note) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-300 line-clamp-2">{note.content.substring(0, 100)}...</p>
                    </div>
                  ))}
                </div>
              )}
