...
import { 
  Link, ChevronLeft, Search, FileText, ExternalLink, 
  AlertTriangle, Check, X, Globe, BookOpen, 
  Clock, Menu, User, ArrowRight, Save, FileEdit
} from 'lucide-react';
...
To jest przykładowy tekst scrapowany ze strony. W rzeczywistej aplikacji byłaby to prawdziwa zawartość ze strony ${url}.`;
      ...
      setTitle(url.includes('wikipedia') ? 'Sztuczna inteligencja' : 'Zawartość strony internetowej');
                  ...
                  <div className="p-4">
                    ...
                    {activeTab === 'original' ? (
                      <div className="bg-slate-900 rounded-lg p-4 min-h-96 overflow-auto">
                        <pre className="text-gray-300 whitespace-pre-wrap font-mono text-sm">{scrapedContent}</pre>
                      </div>
                    ) : (
                      <>
                        <textarea
                        ...
                        <div className="flex justify-between mt-4">
                          ...
                          >
                            ...
                            <ArrowRight className={`ml-1 w-4 h-4 transition-transform ${showPreview ? 'rotate-90' : ''}`} />
                          </button>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="flex items-center text-sm mb-2">
                        <input type="checkbox" className="rounded mr-2 bg-slate-700 border-slate-600" />
              ...
              <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 h-full flex flex-col justify-center items-center py-20">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-400 mb-4 max-w-md mx-auto">
                    Podaj URL strony, którą chcesz zapisać jako notatkę. Narzędzie pobierze tekst i sformatuje go do Markdown.
                  </p>
                </div>
